...
describe DirectSms do
  ...
  describe "sending sms" do
    it 'sends an sms message' do
      stub_request(:get, "http://api.directsms.com.au/s3/http/send_message?max_segments=10&message=This%20is%20a%20test&password=password&to=%2B639178574111&type=2-way&username=username").
        to_return(:status => 200, :body => "id: 1234567890", :headers => {})

      sms = DirectSms::Message.new(username, password)
      sms.message = "This is a test"
      sms.recipients = "+639178574111"
